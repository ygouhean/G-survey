...
Ce dossier contient les images statiques de l'application (logos, backgrounds, etc.).
...
**Important** : Ces images seront servies directement par Vercel depuis le dossier `public/`.
